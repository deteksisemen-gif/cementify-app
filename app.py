...
# ==========================================
# 4. HALAMAN LOGIN (DESAIN SPLIT PRESISI 100%)
# ==========================================
def show_login_page():
    st.markdown("""
        <style>
        ...
        /* Membelah warna latar belakang (50% Putih Abu, 50% Biru Gelap) */
        .stApp {
            background: linear-gradient(to right, #F8F9FA 50%, #2B3A5A 50%) !important;
        }
        
        /* KUNCI: Menghilangkan padding kanan agar gambar bisa melebar sampai ujung */
        .block-container { 
            padding-top: 15vh !important; 
            padding-bottom: 0 !important;
            padding-left: 6vw !important;  
            padding-right: 0 !important; /* Paksa batas kanan hilang */
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            # Gambar kini menempel rata ke sisi kanan layar
            st.markdown(f"""
                <div style="
                    display: flex; 
                ...
                ">
                    ...
                    "/>
                    <div style="width: 100%; text-align: right; color: #94A3B8; font-size: 12px; margin-top: 15px; padding-right: 3vw;">
                        Support &nbsp;&nbsp;&nbsp; Terms
                    </div>
                </div>
            """, unsafe_allow_html=True)
...
# ==========================================
# 5. HALAMAN DASHBOARD UTAMA (DESAIN BARU BIRU & BANNER)
# ==========================================
def show_dashboard_page():
    ...
    if menu == "📊 Dashboard Utama":
        # Menambahkan Header Gambar (Banner) di bagian atas Dashboard
        st.markdown("""
            <div style="
                width: 100%;
                height: 180px;
