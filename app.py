...
def show_login_page():
    ...
    with col_kiri:
        st.markdown("<div style='padding-right: 15%;'>", unsafe_allow_html=True)
        st.markdown("""
...
# ==========================================
# 5. HALAMAN DASHBOARD UTAMA (DESAIN BARU)
# ==========================================
def show_dashboard_page():
    st.markdown("""
        ...
        /* Background Dashboard Nuansa Krem Sangat Muda */
        .stApp { background: #FCFBF9 !important; }
        
        /* Area Sidebar Tetap Biru Gelap */
        ...
        /* Kustomisasi Area Drag & Drop File Uploader */
        ...
        /* Kotak Info Hasil (Meniru gaya kaca/glow) */
        div.stInfo {
        ...
        /* Mempercantik Header DataFrame Bawaan */
    ...
    if menu == "📊 Dashboard Utama":
        st.markdown("<h3 style='color: #2B3A5A;'>📸 Capture & Upload</h3>", unsafe_allow_html=True)
        ...
        with col_kanan:
            st.markdown("<h4 style='color: #2B3A5A;'>🔍 Detection Results</h4>", unsafe_allow_html=True)
        ...
        st.markdown("<h2 style='color: #2B3A5A;'>Database Riwayat Inventori</h2>", unsafe_allow_html=True)
