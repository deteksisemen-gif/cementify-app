...
def show_login_page():
    st.markdown("""
        ...
        [data-testid="column"]:nth-of-type(1) {
            ...
            justify-content: space-between; /* Menjaga elemen tersebar rata di panel kiri */
            height: 100%; /* Memaksa kolom kiri mengisi tinggi maksimum */
        }
        ...
        [data-testid="column"]:nth-of-type(2) {
            ...
            margin-top: 20px;
            height: 100%; /* Memaksa kolom kanan mengikuti tinggi kolom kiri */
        }
        ...
        .stButton>button {
            ...
            margin-top: 15px;
            letter-spacing: 1px;
            width: 100%; /* Memastikan tombol selebar input */
        }
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            # KUNCI PERUBAHAN: height di set ke 100% dan parent div diatur agar merentang penuh
            st.markdown(f"""
                <div style="
                    width: 100%;
                    height: 100%; /* Memastikan div utama merentang penuh */
                    display: flex;
                    flex-direction: column;
                ...
                ">
                    <div style="
                        width: 100%;
                        height: 100%; /* KUNCI: Memaksa gambar merentang setinggi panel kiri */
                        min-height: 480px; /* Batas minimum agar tidak terlalu gepeng jika layarnya kecil */
                        background: #1E1E1E;
                        border-radius: 20px;
