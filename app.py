...
def show_login_page():
    st.markdown("""
        ...
        [data-testid="column"]:nth-of-type(1) {
            ...
            box-shadow: 0 0 20px rgba(26, 115, 232, 0.05), inset 0 0 10px rgba(0,0,0,0.8) !important;
            margin-top: 20px;
            display: flex;
        ...
        [data-testid="column"]:nth-of-type(2) {
            ...
            padding-left: 0vw !important; /* Dihapus agar tidak mendorong ke kanan */
            margin-top: 20px;
        }
        ...
        .stButton>button:hover {
            ...
            box-shadow: 0 0 25px rgba(66, 133, 244, 0.7) !important;
    ...
    with col_kiri:
        st.markdown("""
            <div style="
                ...
                border-radius: 12px;
                padding: 12px 20px;
                box-shadow: 6px 6px 12px #111111, -6px -6px 12px #2b2b2b;
                border: 1px solid #333;
                display: inline-block;
                margin-bottom: 25px;
            ">
                <h3 style='margin:0; font-weight: 900; font-size: 26px; color: #E0E0E0; letter-spacing: 1px;'>
                    <span style="color:#4285F4;">⚙️</span> Cementify
                </h3>
            </div>
            ...
            st.markdown(f"""
                ...
                ">
                    <div style="
                        ...
                        box-shadow: 8px 8px 20px rgba(0, 0, 0, 0.6), -4px -4px 15px rgba(255, 255, 255, 0.03);
                        overflow: hidden;
                        display: flex;
                        justify-content: center;
                        align-items: center;
                    ...
                    <div style="width: 100%; max-width: 550px; text-align: right; color: #555555; font-size: 13px; margin-top: 15px; font-weight: 600;">
                        Support &nbsp;&nbsp;&nbsp; Terms
                    </div>
                </div>
            """, unsafe_allow_html=True)
