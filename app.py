...
def show_login_page():
    st.markdown("""
        ...
        [data-testid="column"]:nth-of-type(1) {
            ...
            box-shadow: 0 0 20px rgba(255, 102, 0, 0.05), inset 0 0 10px rgba(0,0,0,0.8) !important;
            margin-top: 20px;
        }
        ...
        .stButton>button:hover {
            background: linear-gradient(180deg, #A00000 0%, #600000 100%) !important;
    ...
    with col_kiri:
        st.markdown("""
            <h3 style='margin:0; font-weight: 900; font-size: 26px; margin-bottom: 25px; color: #E0E0E0;'>
                <span style="color:#777777;">⚙️</span> Cementify
            </h3>
        ...
        st.markdown("<div style='text-align: right; color: #888888; font-size: 13px; margin-top: -10px; margin-bottom: 20px; cursor: pointer; font-weight: 600; transition: color 0.3s;' onmouseover=\"this.style.color='#FF6600'\" onmouseout=\"this.style.color='#888888'\">Forgot Password?</div>", unsafe_allow_html=True)
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            st.markdown(f"""
                ...
                <div style="width: 100%; text-align: right; color: #555555; font-size: 13px; margin-top: 15px; font-weight: 600;">
                    Support &nbsp;&nbsp;&nbsp; Terms
                </div>
            """, unsafe_allow_html=True)
        else:
