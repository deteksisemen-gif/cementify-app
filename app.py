...
def show_login_page():
    st.markdown("""
        ...
        .stApp {
            background: linear-gradient(to right, #F5F6F8 45.5%, #334155 45.5%) !important;
        }
        
        /* Desain Kolom Input: Transparan & Bergaris Hitam/Gelap */
        ...
        /* Penyesuaian Ruang Panel Kiri */
        .left-panel { padding: 15% 10% 15% 15%; }
        </style>
