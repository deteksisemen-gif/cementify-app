...
def show_login_page():
    st.markdown("""
        ...
        /* 2. PANEL LOGIN DENGAN NEON GLOW */
        [data-testid="column"]:nth-of-type(1) {
            ...
            border: 1px solid rgba(66, 133, 244, 0.25) !important; /* Border biru transparan */
            box-shadow: 0 0 45px rgba(66, 133, 244, 0.12), inset 0 0 15px rgba(0,0,0,0.8) !important; /* Pendaran Neon */
            margin-top: 20px;
            display: flex;
        ...
        .stTextInput>div>div>input:focus {
            ...
            box-shadow: 0 0 12px rgba(66, 133, 244, 0.4) !important;
        }
        ...
        .stButton>button {
            ...
            box-shadow: 0 0 25px rgba(26, 115, 232, 0.5) !important; /* Neon glow tombol diperkuat */
            transition: all 0.3s ease;
            margin-top: 15px;
            letter-spacing: 1px;
        }
        .stButton>button:hover {
            ...
            box-shadow: 0 0 35px rgba(66, 133, 244, 0.8) !important;
    ...
    with col_kiri:
        st.markdown("""
            <div style="
                ...
                border-radius: 12px;
                padding: 12px 20px;
                box-shadow: 6px 6px 12px #111111, -6px -6px 12px #2b2b2b, 0 0 15px rgba(66, 133, 244, 0.1);
                border: 1px solid rgba(66, 133, 244, 0.2);
                display: inline-block;
                margin-bottom: 25px;
            ">
                <h3 style='margin:0; font-weight: 900; font-size: 26px; color: #E0E0E0; letter-spacing: 1px;'>
                    <span style="color:#4285F4; text-shadow: 0 0 10px rgba(66, 133, 244, 0.6);">⚙️</span> Cementify
                </h3>
            </div>
            ...
            st.markdown(f"""
                ...
                ">
                    <div style="
                        ...
                        background: #1E1E1E;
                        border-radius: 20px;
                        border: 1px solid rgba(66, 133, 244, 0.25); /* Border biru transparan */
                        box-shadow: 0 0 45px rgba(66, 133, 244, 0.12), 0 15px 35px rgba(0, 0, 0, 0.6); /* Pendaran Neon */
                        overflow: hidden;
                        display: flex;
                        justify-content: center;
                        align-items: center;
                    ...
                    <div style="width: 100%; max-width: 600px; text-align: right; color: #555555; font-size: 13px; margin-top: 15px; font-weight: 600;">
                        Support &nbsp;&nbsp;&nbsp; Terms
                    </div>
                </div>
            """, unsafe_allow_html=True)
