...
def show_login_page():
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            # KUNCI PERUBAHAN: Menghapus height fix dan margin negatif agar gambar mengikuti aliran flexbox Streamlit secara natural.
            st.markdown(f"""
                <div style="
                    width: 100%;
                    display: flex;
                    ...
                    justify-content: center;
                    align-items: center; 
                    margin-bottom: 55px; /* Memberikan ruang bawah agar sejajar dengan kolom kiri */
                ">
                    <div style="
                        width: 100%;
                        background: #1E1E1E;
