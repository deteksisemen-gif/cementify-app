...
def show_dashboard_page():
    st.markdown("""
        <style>
        /* Mengubah Sidebar menjadi Biru Gelap sesuai Mockup */
        ...
        /* Tombol Proses Warna Kuning Kontras */
        .btn-proses>button {
        ...
        /* Styling Kartu untuk hasil dan input */
    ...
    if menu == "📊 Dashboard Utama":
        ...
        with col_kiri:
            # Menggunakan sistem Tabs agar tampilan input menyerupai Card terpisah
        ...
        if not st.session_state["history_table"].empty:
            # Hanya menampilkan 5 data terakhir di halaman utama agar rapi
