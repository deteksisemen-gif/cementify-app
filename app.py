...
# ==========================================
# 4. HALAMAN LOGIN (REVISI FIX ALIGNMENT & GLASS)
# ==========================================
def show_login_page():
    st.markdown("""
        <style>
        ...
        /* 1. BACKGROUND MERIAH (Gradien Biru + Pola Titik Merah & Biru) */
        .stApp {
            background-color: #f4f7fb !important;
            background-image: 
                radial-gradient(#0047FF 1.5px, transparent 1.5px),
                radial-gradient(#FF0033 1.5px, transparent 1.5px),
                linear-gradient(135deg, #ffffff 30%, #E6EFFF 60%, #0047FF 100%) !important;
        ...
        /* 2. KARTU KIRI (EFEK GLASSMORPHISM NYATA) */
        [data-testid="column"]:nth-of-type(1) {
            ...
            box-shadow: 0 20px 50px rgba(0, 0, 0, 0.15), 0 0 0 2px rgba(255, 255, 255, 0.8) inset !important;
            margin-top: 20px;
        }

        /* 3. KARTU KANAN (GAMBAR TERKUNCI DI TENGAH) */
        ...
        /* Username Glow Biru saat fokus */
        .stTextInput:nth-of-type(1)>div>div>input:focus {
            border-color: #0047FF !important;
            box-shadow: 0 0 15px rgba(0, 71, 255, 0.3) !important;
        }
        /* Password Glow Merah saat fokus */
        .stTextInput:nth-of-type(2)>div>div>input:focus {
            border-color: #FF0033 !important;
            box-shadow: 0 0 15px rgba(255, 0, 51, 0.3) !important;
        }
        
        /* Tombol Merah Menyala */
        .stButton>button {
            ...
            box-shadow: 0 10px 25px rgba(255, 0, 51, 0.45) !important;
            transition: all 0.3s ease;
            margin-top: 15px;
        }
        .stButton>button:hover {
            transform: translateY(-3px);
            box-shadow: 0 15px 35px rgba(255, 0, 51, 0.6) !important;
        }
        </style>
    """, unsafe_allow_html=True)

    col_kiri, col_kanan = st.columns([1, 1.1], gap="medium")
    ...
    with col_kiri:
        st.markdown("""
            ...
            <h1 style='font-size: 42px; color: #0F172A; font-weight: 800; margin-bottom: 5px; line-height: 1.2;'>Welcome Back!</h1>
        ...
        st.markdown("<div style='text-align: right; color: #64748B; font-size: 13px; margin-top: -10px; margin-bottom: 20px; cursor: pointer; font-weight: 600;'>Forgot Password?</div>", unsafe_allow_html=True)
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            st.markdown(f"""
                ...
                <div style="width: 100%; text-align: right; color: #FFFFFF; font-size: 13px; margin-top: 15px; font-weight: 600; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">
                    Support &nbsp;&nbsp;&nbsp; Terms
                </div>
            """, unsafe_allow_html=True)
        else:
            st.warning("Foto 'gambar ilustrasi web.jpg' tidak ditemukan.")
