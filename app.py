...
# ==========================================
# 4. HALAMAN LOGIN (DESAIN SPLIT SIMETRIS)
# ==========================================
def show_login_page():
    st.markdown("""
        <style>
        ...
        /* Mengamankan margin kiri dan kanan agar sama persis (7vw) */
        .block-container { 
    ...
    with col_kiri:
        # Memberi jarak aman agar formulir tidak menempel ke garis tengah layar
        st.markdown("<div style='padding-right: 8%;'>", unsafe_allow_html=True)
        st.markdown("""
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            # Memberi jarak aman agar gambar tidak menempel ke garis tengah layar, dan border melengkung sempurna
            st.markdown(f"""
                <div style="
                    display: flex; 
