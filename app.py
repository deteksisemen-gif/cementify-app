...
# ==========================================
# 4. HALAMAN LOGIN (DESAIN SPLIT KONTRAK)
# ==========================================
def show_login_page():
    st.markdown("""
        <style>
        ...
        /* Mereset padding bawaan agar warna background bisa full ujung ke ujung */
        .block-container { padding: 0 !important; max-width: 100% !important; overflow: hidden; }
        #MainMenu, header, footer {visibility: hidden;}
        
        /* Trik Linear Gradient membelah layar: 45.5% Abu-abu Terang, Sisanya Biru Gelap */
        .stApp {
            background: linear-gradient(to right, #F8F9FA 45.5%, #2B3A5A 45.5%) !important;
        }
        
        /* Mengembalikan gaya Input Streamlit ke mode stabil dengan sudut membulat */
        .stTextInput>div>div>input { 
            border-radius: 8px !important; 
            padding: 10px 15px !important; 
        }
        
        /* Desain Tombol LOGIN Biru Gelap Pill-Shape */
        .stButton>button {
        ...
        /* Penyesuaian Ruang Panel Kiri (Dipersempit sedikit di kanan agar tidak menabrak batas warna) */
        .left-panel { padding: 15% 15% 15% 10%; }
        </style>
    """, unsafe_allow_html=True)

    col_kiri, col_kanan = st.columns([1, 1.2], gap="medium")
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            # Gambar dibuat melayang di tengah area Biru Gelap
            st.markdown(f"""
                <div style="
                    display: flex; 
