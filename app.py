        ...
        if os.path.exists(img_path):
            ...
            st.markdown(f"""
                <div style="
                    ...
                    flex-direction: column;
                    justify-content: center;
                    align-items: center; /* Dipusatkan agar seimbang di tengah kolom */
                ">
                    <div style="
                        width: 100%;
                        aspect-ratio: 4/3; /* KUNCI: Menjaga rasio landscape yang presisi tanpa batas tinggi statis */
                        background: #1E1E1E;
                        border-radius: 20px;
                        border: 2px solid rgba(66, 133, 244, 0.8); /* Border neon menyala terang */
