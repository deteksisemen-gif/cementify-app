...
def show_login_page():
    ...
    with col_kanan:
        ...
        if os.path.exists(img_path):
            ...
            # KUNCI PERUBAHAN: height diubah ke 330px dan ditambah transform: translateY(-35px)
            st.markdown(f"""
                <div style="
                    width: 100%;
                    height: 100%;
                ...
                ">
                    <div style="
                        width: 100%;
                        height: 330px; /* KUNCI: Tinggi fix agar proporsional */
                        transform: translateY(-35px); /* KUNCI: Menggeser gambar ke atas agar sejajar persis dengan field Password */
                        background: #1E1E1E;
                        border-radius: 20px;
                    ...
                    <div style="width: 100%; text-align: right; color: #555555; font-size: 13px; transform: translateY(-15px); font-weight: 600; padding-right: 5px;">
                        Support &nbsp;&nbsp;&nbsp; Terms
                    </div>
                </div>
            """, unsafe_allow_html=True)
