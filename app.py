...
def show_login_page():
    st.markdown("""
        ...
        /* Membelah warna latar belakang (42% Putih Abu, 58% Biru Gelap) */
        .stApp {
            background: linear-gradient(to right, #F8F9FA 42%, #2B3A5A 42%) !important;
        }
        
        /* Mengamankan padding konten agar terdorong menjauhi pinggir layar */
        .block-container { 
            padding-top: 12vh !important; 
            padding-bottom: 0 !important;
            padding-left: 8vw !important;  /* Trik jitu mendorong form ke kanan */
    ...
    # Proporsi disesuaikan agar form benar-benar berada di dalam area 42% warna putih
    col_kiri, col_kanan = st.columns([0.85, 1.25], gap="large")
