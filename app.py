...
def show_login_page():
    st.markdown("""
        ...
        .block-container { padding: 2rem 1rem !important; max-width: 100% !important; overflow: hidden; }
        #MainMenu, header, footer {visibility: hidden;}
        .left-panel { padding: 10% 12%; }
    ...
    with col_kiri:
        ...
        st.markdown("""
            <h3 style='margin:0; font-weight: 800; color: #0F172A; font-size: 26px; margin-bottom: 50px;'>Cementify ⚙️</h3>
            <h1 style='font-size: 42px; color: #0F172A; font-weight: 800; margin-bottom: 5px;'>Welcome Back!</h1>
            <p style='color: #64748B; margin-bottom: 30px;'>Please login to manage your inventory</p>
        """, unsafe_allow_html=True)
        ...
        # Tombol Login Lebar Penuh (Tipe Primary bawaan Streamlit agar responsif)
    ...
    with col_kanan:
        # Trik Base64 untuk mengubah foto lokal menjadi Wallpaper Penuh
